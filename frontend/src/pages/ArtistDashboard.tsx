 ...
 * @description Artist's personal dashboard — commission-focused analytics.
 *
 * Shows:
 *   - Profile card with commission %
 *   - Highlighted commission earned (the star metric)
 *   - KPI cards: revenue, customers, services, hours
 *   - Date-range filter (today / this month / 3 months / year / custom)
 *   - Top services breakdown
 *   - Daily revenue + commission trend chart
 *
 * Auto-refreshes every 30 seconds for near real-time commission updates.
 */
...
export default function ArtistDashboard() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#faf8f4" }}>
      {/* ── Top Nav Bar ── */}
      <header
        className="sticky top-0 z-30 flex items-center justify-between px-4 sm:px-8 h-16"
        style={{
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold text-stone-900 text-base tracking-tight">My Dashboard</span>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-sm text-stone-500 hover:text-red-500 transition-colors px-2 py-1.5 rounded-lg hover:bg-red-50"
          >
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-8 py-6 sm:py-8">
        ...
        {profile && (
          ...
          >
            ...
            {/* Commission Highlight — THE STAR CARD */}
            <div
              ...
              <div className="space-y-2 max-h-80 overflow-y-auto pr-1">
                ...
                <div className="flex items-center gap-4 pt-2 border-t border-stone-100 mt-2">
                  ...
                  <span className="flex items-center gap-1.5 text-xs text-amber-600">
                    <span className="w-3 h-2 rounded bg-amber-400" /> Your Commission
                  </span>
                </div>
              </div>
            )}
          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
              ...
              <div>
                ...
                <p className="text-xs text-stone-500 uppercase tracking-wider font-semibold mt-0.5">Your Commission</p>
              </div>
              <div>
